...
// in fake_store/test/unit/home_repo_test.dart.
...
import 'package:fake_store/features/home/data/apis/home_api_service.dart'
    as _i2;
import 'package:fake_store/features/home/data/models/product_model.dart' as _i4;
...
class MockHomeApiService extends _i1.Mock implements _i2.HomeApiService {
  ...
  @override
  _i3.Future<List<_i4.ProductModel>> getCategoryProducts(
    String? categoryName,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#getCategoryProducts, [categoryName]),
            returnValue: _i3.Future<List<_i4.ProductModel>>.value(
              <_i4.ProductModel>[],
            ),
          )
